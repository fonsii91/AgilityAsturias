...
## ESTADO ACTUAL:
- **[Completado 2026-05-22]** Desplegada versión 1.1.42. Incluye el autocompletado en el formulario de competiciones para rellenar automáticamente todos los datos al introducir un enlace de FlowAgility o al buscar un evento por su nombre, y la automatización para pasar asistencia y asignar puntos de forma automática al finalizar competiciones de FlowAgility (marcando los perros presentes, calculando puntos según clasificación, generando historiales y enviando notificaciones). Se añade la pestaña "Eventos de FlowAgility" en el monitor de scraping de la administración. También se integra la automatización para extraer, digitalizar y publicar las clasificaciones de la Liga Norte desde capturas de Telegram, usando Gemini Vision AI con mapeo difuso de binomios al club en el panel de administración, y mostrando la clasificación pública en tiempo real destacando los binomios de Asturias.
