...
## ESTADO ACTUAL:
- **[Completado 2026-06-06]** Desplegada versión 1.1.50. Corrige el botón de pantalla completa en iPhones/iOS para que los usuarios puedan ampliar los vídeos a pantalla completa con total normalidad desde la galería (aplicable a vídeos de Bunny.net, Bitmovin HLS y locales), y añade sincronización de reproducción al salir del modo de pantalla completa. Adicionalmente, se automatiza todo el proceso de registro y configuración de clubes: Nginx ahora soporta subdominios comodín (*.clubagility.com y *.agilityasturias.com) de manera dinámica y el backend aprovisiona de forma inmediata la base de datos del club (activando módulos según el plan) y la cuenta de administrador (manager), enviándole al instante un correo de bienvenida con un enlace de activación seguro para definir su contraseña.
