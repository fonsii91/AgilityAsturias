...
## ESTADO ACTUAL:
- **[Completado 2026-06-03]** Desplegada versión 1.1.47. Unifica y optimiza el almacenamiento de las carreras en la base de datos bajo el patrón Single Table Inheritance (STI). Centraliza las bitácoras RFEC y RSCE en una sola tabla `tracks`, mejorando la rapidez y eficiencia al consultar el Seguimiento Provisional y las bitácoras de los perros.
