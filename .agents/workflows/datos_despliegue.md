...
## ESTADO ACTUAL:
- **[Completado 2026-05-22]** Automatizado el scraper de FlowAgility para que se ejecute todas las madrugadas a las 4:00 AM. Se ajustó la lógica para que las competiciones finalizadas solo se marquen como completadas (`results_scraped = true`) cuando comprobamos que se han importado resultados para cada uno de los días del evento, o cuando transcurre un periodo de gracia de 5 días tras su finalización (para evitar bucles diarios si no se subieron todos los datos o si ningún perro del club participó en algún día).
