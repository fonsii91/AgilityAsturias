...
## ESTADO ACTUAL:
- **[Completado 2026-06-02]** Desplegada versión 1.1.46. Implementa la subida de vídeos en segundo plano con cola global (`UploadService` y `UploadProgressPanelComponent`) y solventa las restricciones de dominios de Bunny.net Stream (`localhost:4200`) con un overlay informativo en caso de fallo de red/dominio.
