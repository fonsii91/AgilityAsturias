...
## ESTADO ACTUAL:
- **[Completado 2026-05-22]** Automatizado el scraper de FlowAgility para que se ejecute todas las madrugadas a las 4:00 AM. Se ajustó la lógica para que las competiciones en curso no se marquen como finalizadas (`results_scraped = true`) y se sigan procesando automáticamente hasta que terminen.
