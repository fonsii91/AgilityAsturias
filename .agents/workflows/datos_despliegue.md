...
## ESTADO ACTUAL:
- **[Completado 2026-06-01]** Desplegada versión 1.1.45. Corrige el error en el seguimiento de ascensos (Grade 1 y Grade 2) y del Campeonato de España para que las pistas excelentes a cero importadas o scrapeadas (registradas con el código de calificación `EXC_0` u otros alias válidos) se computen correctamente para las medallas y porcentajes de avance. También se actualizó el cálculo de puntuación en el módulo de la RFEC para admitir los alias `exc_0` (10 ptos) y `exc` (5 ptos).
