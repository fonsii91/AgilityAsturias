...
## ESTADO ACTUAL:
- **[Completado 2026-06-06]** Desplegada versión 1.1.50. Corrige el botón de pantalla completa en iPhones/iOS para que los usuarios puedan ampliar los vídeos a pantalla completa con total normalidad desde la galería (aplicable a vídeos de Bunny.net, Bitmovin HLS y locales), y añade sincronización de reproducción al salir del modo de pantalla completa.
