...
## ESTADO ACTUAL:
- **[Completado 2026-06-06]** Desplegada versión 1.1.50. Corrige el botón de pantalla completa en iPhones/iOS para que los usuarios puedan ampliar los vídeos, y soluciona el error por el cual los vídeos de tipo \"Jumping\" se guardaban y subían a YouTube catalogados siempre como \"Agility\". También implementa el soporte para descargas y retransmisión adaptativa en tiempo real de vídeos alojados en Bunny.net desde la app. Adicionalmente, se automatiza todo el proceso de registro y configuración de clubes: Nginx ahora soporta subdominios comodín (*.clubagility.com y *.agilityasturias.com) de manera dinámica y el backend aprovisiona de forma inmediata la base de datos del club (activando módulos según el plan) y la cuenta de administrador (manager), enviándole al instante un correo de bienvenida con un enlace de activación seguro para definir su contraseña.
- **[Completado 2026-06-05]** Desplegada versión 1.1.49. Implementa la sección de Patrocinadores (Sponsors) pública y su respectivo panel CRUD de gestión en la administración del club integrado con validaciones de formulario, subida y compresión de imágenes, y modales interactivos de borrado. El diseño se adaptó al sistema dinámico de theming multi-tenant, y los botones de edición/borrado se optimizaron con áreas táctiles ampliadas de 38px y alineaciones perfectamente centradas. Adicionalmente, se corrige el mensaje de restricción de reproducción de vídeos en Bunny.net Stream para que muestre de forma dinámica el dominio real visitado en producción en lugar del host local de desarrollo, facilitando la identificación y autorización del dominio correcto.
