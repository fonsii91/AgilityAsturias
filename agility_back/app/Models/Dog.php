...
class Dog extends Model
{
    ...
    protected $fillable = [
        ...
        'pedigree',
        'photo_url',
        'avatar_cansancio_1_url',
        'avatar_cansancio_2_url',
        'avatar_cansancio_3_url',
        'avatar_cansancio_4_url',
        'avatar_cansancio_5_url',
        'points',
    ...
    {
        return $this->belongsToMany(User::class)->using(DogUser::class)->withPivot('is_primary_owner', 'rsce_license', 'rsce_expiration_date', 'rsce_grade', 'rsce_handler_category', 'sociability_test_passed');
    }
